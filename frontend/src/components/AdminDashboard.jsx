              ...
              <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
                ...
                <div className="card-elevated overflow-hidden xl:col-span-5 flex flex-col h-fit">
                  <div className="px-5 py-3 bg-blue-50 border-b border-blue-100 flex items-center justify-between">
                    ...
                    <span className="text-xs font-medium text-emerald-600 bg-emerald-50 px-2 py-1 rounded-md border border-emerald-100 flex items-center gap-1">
                      <svg xmlns="http://www.w3.org/2000/svg" className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                      AI Confidence: {selected.id ? (selected.id.charCodeAt(selected.id.length - 1) % 12) + 87 : 94}%
                    </span>
                  </div>
